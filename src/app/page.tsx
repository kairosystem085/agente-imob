...
const highlights = [
  {
    ...
    text: "Receba, qualifique e organize leads vindos do WhatsApp sem perder o controle humano.",
    icon: MessageCircle
  },
  {
    title: "Multi-tenant real",
    text: "A mesma base atende corretor autonomo, imobiliaria, construtora e operacoes maiores.",
    icon: Building2
  },
  {
    title: "IA com proposito",
    text: "A IA pergunta, entende a necessidade, sugere imoveis e prepara o agendamento.",
    icon: Sparkles
  }
];
      ...
      <section className="mx-auto flex min-h-screen max-w-7xl flex-col justify-between px-6 py-6 lg:px-8">
        <nav className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link href="/dashboard" className="rounded-md bg-ink px-4 py-2 text-sm font-semibold text-white shadow-soft">Ver demo</Link>
          </div>
        </nav>

        <div className="grid items-center gap-10 py-16 lg:grid-cols-[1.05fr_0.95fr]">
          <div>
            <p className="mb-4 text-sm font-semibold uppercase tracking-[0.18em] text-signal">SaaS imobiliario com IA</p>
            <h1 className="max-w-3xl text-5xl font-semibold tracking-normal text-ink md:text-7xl">ImobIA</h1>
            <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-600">
              Plataforma de atendimento imobiliario que qualifica leads, encontra imoveis,
              agenda visitas e notifica corretores no proprio numero.
            </p>
            <div className="mt-8 flex flex-wrap gap-3">
              <Link href="/dashboard" className="rounded-md bg-signal px-5 py-3 text-sm font-semibold text-white shadow-soft">Abrir dashboard</Link>
              <Link href="/catalogo/joao-corretor" className="rounded-md border border-slate-200 bg-white px-5 py-3 text-sm font-semibold text-ink">Ver catalogo publico</Link>
            </div>
          </div>
          ...
          <div className="rounded-lg border border-white/80 bg-white/85 p-4 shadow-soft backdrop-blur">
            <div className="rounded-md bg-ink p-5 text-white">
              <div className="flex items-center justify-between border-b border-white/10 pb-4">
                <span className="text-sm font-semibold">Lead quente</span>
              ...
              <div className="space-y-4 pt-5">
                ...
                <div className="grid grid-cols-3 gap-3">
                  {["Qualificada", "3 matches", "Corretor avisado"].map((item) => (
